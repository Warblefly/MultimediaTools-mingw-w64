...
if  [[ "$dump_archive" = [Yy] ]]; then
  ...
  tar hacvvf ${dump_file} ./bin/*exe ./bin/*com ./bin/*dll ./bin/*py ./bin/*pl ./bin/*cmd ./bin/*config ./bin/platforms/*dll ./lib/frei0r-1/* ./lib/mlt/* ./plugins/* ./share/OpenCV/* ./share/tessdata || exit 1
