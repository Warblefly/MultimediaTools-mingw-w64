...
File /nonfatal /r "./bin/*.h"
File /nonfatal /r "./bin/*.ttl"
File /nonfatal /r "./bin/*.a"
...
${EnvVarUpdate} $0 PATHEXT "A" "HKCU" ".COM;.EXE;.BAT;.CMD;.VBS;.VBE;.JS;.JSE;.WSF;.WSH;.MSC;.PL;.PY"
...
${EnvVarUpdate} $0 VLC_PLUGIN_PATH "A" "HKCU" "$INSTDIR\lib\vlc\plugins"
${EnvVarUpdate} $0 QML2_IMPORT_PATH "A" "HKCU" "$INSTDIR\qml"
...
if [[ "${upload_archive}" = [Yy] ]]; then
  ...
  sshpass -p "${upload_password}" rsync -avP -e ssh --progress MultimediaTools-mingw-w64-Open-source.exe "${upload_location}"
